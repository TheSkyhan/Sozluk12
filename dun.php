...
//$dun = strtotime(date("Y-m-d")) - 86400;
$dun = strtotime("-1 day");

$bugun = date("Y-m-d", $dun);
//echo $bugün;
...
<table border="0" width="90%" align="left">
    <tr>
        <td style="font-size:8pt;text-align:center;text-decoration:none;"><?php echo date("d-m-Y", strtotime($bugun)) . " .. (" . mysqli_num_rows($result) . " başlık)"?></td>
    </tr>
    <?php
    while ($row = mysqli_fetch_array($result))
    {
        ...
        <tr>
            <td align="left" class="left-menu">
                <a href="goster.php?konu=<?php echo urlencode($row["entry_baslik"]);?>&zaman=<?php echo date('Y-m-d', strtotime('-1 day'));?>"
