...
if (isset($_POST["gönder"])) {
    ...
    $sql = "INSERT INTO tbl_users (`user_nick`, `user_email`, `user_pwd`, `user_dogumtarihi`, `user_kayittarihi`, `user_cinsiyet`)
			VALUES ('" . mysqli_real_escape_string(trim($_POST["nick"])) . "', '" . mysqli_real_escape_string(trim($_POST["mail"])) . "', '" . mysqli_real_escape_string(md5($_POST["pwd"])) . "', '" . mysqli_real_escape_string($kayittarihi) . "', '" . date("Y-m-d") . "', '" . mysqli_real_escape_string($_POST["cinsiyet"]) . "')";
