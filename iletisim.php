...
if (isset($_POST["gönder"])) {
    ...
    <table width="50%" border="0">
    	...
    	<tr>
    	    <td colspan="2" align="justify">Ar$iv Sözlük ile ilgili düşünce görüş önerilerinizi bildirmek, merak
    	...
    	<tr>
    	    ...
    	    <td align="left"><input type="text" id="konu" name="konu" size="50"
    				    value="<?= isset($_GET["sikayet_konusu"]) ? htmlspecialchars($_GET["sikayet_konusu"]) : ''; ?>">
	    </td>
	</tr>
	<tr>
