...
if (isset($_POST["submit"])) {
    ...
    SET entry_text='" . mysqli_real_escape_string($_POST["entry_text"]) . "' , entry_sonedittarihi ='" . mysqli_real_escape_string($_POST["zaman"]) . "'
    WHERE entry_id=" . intval($_POST["id"]) . " AND entry_yazar = '".  mysqli_real_escape_string($yazar)."'";

    $result = mysqli_query($conn, $sql);
    if (isset($_POST['baslik_duzenle'])) {
	$sql = "UPDATE tbl_entries
    SET entry_baslik='" . mysqli_real_escape_string(strtolower_tr($_POST["baslik_duzenle"])) . "' , entry_sonedittarihi ='" . mysqli_real_escape_string($_POST["zaman"]) . "'
    WHERE entry_baslik='" . mysqli_real_escape_string($_POST["baslik"]) . "'";
	$result = mysqli_query($conn, $sql);
    }
    if ($result)
...
if (isset($_POST["ispiyon"])) {
    ...
    VALUES (NULL, " . intval($_POST["id"]) . ", '" . mysqli_real_escape_string($yazar) . "', '" . mysqli_real_escape_string($_POST["ispiyon_text"]) . "')";
    $result = mysqli_query($conn, $sql);
    if ($result)
    ...
    WHERE entry_id ='" . $msgid . "'";
	    ...
	    $baslik = mysqli_real_escape_string($row["entry_baslik"], $conn);
